...
console.log('radiusResult Exercise: ', getCircleCircumferenceResult);

function getFullName(firstName, lastName) {
  return firstName + lastName;
}
var getFullNameResult = getFullName('Marc ', 'Ting');
console.log('getFullNameResult Exercise: ', getFullNameResult);
